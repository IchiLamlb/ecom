              ...
              <TextArea
                ...
                value={
                  ...
                  (this.totalAmount(this.state.oneYearAgo) &&
                    ...
                    ? "Tính đến thời điểm hiện tại năm nay cửa hàng mình đạt doanh thu cao hơn so với năm trước nên nhập thêm nhiều mặt hàng để phục vụ nhu cầu của khách hàng"
                    : "Tính đến thời điểm hiện tại, năm nay cửa hàng chúng tôi có doanh thu ít hơn so với năm trước. Ngoài ra, để cải thiện doanh thu cửa hàng cần giảm giá một số sản phẩm và tạo các sự kiện mới để thu hút khách hàng."
                }
              />
            </p>
          </Modal>
