...
class FixedPlugin extends Component {
  ...
  handleClick = () => {
    this.setState(prevState => ({
      classes: prevState.classes === "dropdown show-dropdown" 
  ...
  render() {
    // Destructure the isVisible prop
            ...
            <li className="adjustments-line">
              <div className="badge-colors text-center">
                <span
                  ...
                  data-color="primary"
                  onClick={() => this.props.handleBgClick("primary")}
                />{" "}
                <span
                  className={
                  ...
                  data-color="blue"
                  onClick={() => this.props.handleBgClick("blue")}
                />{" "}
                <span
                  className={
                  ...
                  data-color="green"
                  onClick={() => this.props.handleBgClick("green")}
                />{" "}
              </div>
            </li>
